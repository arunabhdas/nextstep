...
public class FragmentDrawerEight extends Fragment {
    private static final String TAG = "FragmentDrawerEight";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.fragment_drawer_eight, null);

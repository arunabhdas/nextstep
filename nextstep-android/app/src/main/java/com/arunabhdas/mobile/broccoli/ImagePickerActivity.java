...
public final class ImagePickerActivity extends AppCompatActivity {
    ...
    /**
     * For images captured from the camera, we need to menu_actions a File first to tell the camera
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent != null) {
            ...
            try {
                ...
                genericError("Could not menu_actions imageFile for camera");
            }
        }
    }
    ...
    private void genericError(String message) {
        Toast.makeText(this, message == null ? getString(R.string.label_something_went_wrong) : message, Toast.LENGTH_SHORT).show();
    }

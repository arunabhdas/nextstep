...
public class FragmentDrawerSix extends Fragment {
    private static final String TAG = "FragmentDrawerSix";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.fragment_drawer_six, null);
